<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发生地" prop="fashengdi">
          <el-input v-model="ruleForm.fashengdi" 
              placeholder="发生地" clearable  :readonly="ro.fashengdi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发生地" prop="fashengdi">
              <el-input v-model="ruleForm.fashengdi" 
                placeholder="发生地" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="主要参与人物" prop="zhuyaocanyurenwu">
          <el-input v-model="ruleForm.zhuyaocanyurenwu" 
              placeholder="主要参与人物" clearable  :readonly="ro.zhuyaocanyurenwu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="主要参与人物" prop="zhuyaocanyurenwu">
              <el-input v-model="ruleForm.zhuyaocanyurenwu" 
                placeholder="主要参与人物" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="警号" prop="jinghao">
          <el-input v-model="ruleForm.jinghao" 
              placeholder="警号" clearable  :readonly="ro.jinghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="警号" prop="jinghao">
              <el-input v-model="ruleForm.jinghao" 
                placeholder="警号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupianfengmian" label="图片封面" prop="tupianfengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupianfengmian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="事件内容" prop="shijianneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.shijianneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shijianneirong" label="事件内容" prop="shijianneirong">
                    <span v-html="ruleForm.shijianneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="处理方式" prop="chulifangshi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.chulifangshi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.chulifangshi" label="处理方式" prop="chulifangshi">
                    <span v-html="ruleForm.chulifangshi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	leixing : false,
	fashengdi : false,
	zhuyaocanyurenwu : false,
	shijianneirong : false,
	chulifangshi : false,
	jinghao : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.leixing = true;
          ...
          if(o=='fashengdi'){
            this.ruleForm.fashengdi = obj[o];
	    this.ro.fashengdi = true;
            continue;
          }
          if(o=='zhuyaocanyurenwu'){
            this.ruleForm.zhuyaocanyurenwu = obj[o];
	    this.ro.zhuyaocanyurenwu = true;
            continue;
          }
          if(o=='shijianneirong'){
            this.ruleForm.shijianneirong = obj[o];
	    this.ro.shijianneirong = true;
            continue;
          }
          if(o=='chulifangshi'){
            this.ruleForm.chulifangshi = obj[o];
	    this.ro.chulifangshi = true;
            continue;
          }
          if(o=='jinghao'){
            this.ruleForm.jinghao = obj[o];
	    this.ro.jinghao = true;
            continue;
          }
          if(o=='tupianfengmian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.jinghao!=''&&json.jinghao){
                this.ruleForm.jinghao = json.jinghao
	    		this.ro.jinghao = true;
		}
        } else {
	...
	this.ruleForm.shijianneirong = this.ruleForm.shijianneirong.replace(reg,'../../../springboots6ag7/upload');
	this.ruleForm.chulifangshi = this.ruleForm.chulifangshi.replace(reg,'../../../springboots6ag7/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.tupianfengmian!=null) {
		this.ruleForm.tupianfengmian = this.ruleForm.tupianfengmian.replace(new RegExp(this.$base.url,"g"),"");
	}
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shijiananjian/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shijiananjianCrossAddOrUpdateFlag = false;
						 this.parent.search();
