<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公告类型" prop="gonggaoleixing">
          <el-input v-model="ruleForm.gonggaoleixing" 
              placeholder="公告类型" clearable  :readonly="ro.gonggaoleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公告类型" prop="gonggaoleixing">
              <el-input v-model="ruleForm.gonggaoleixing" 
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.gonggaowenjian" label="公告文件" prop="gonggaowenjian">
          <file-upload
          tip="点击上传公告文件"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.gonggaowenjian?ruleForm.gonggaowenjian:''"
          @change="gonggaowenjianUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.gonggaowenjian" label="公告文件" prop="gonggaowenjian">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.gonggaowenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gonggaoneirong" label="公告内容" prop="gonggaoneirong">
                    <span v-html="ruleForm.gonggaoneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.faburen = true;
          ...
          if(o=='gonggaowenjian'){
            this.ruleForm.gonggaowenjian = obj[o];
	    this.ro.gonggaowenjian = true;
            continue;
          }
          if(o=='fengmian'){
	...
	this.ruleForm.gonggaoneirong = this.ruleForm.gonggaoneirong.replace(reg,'../../../springboots6ag7/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.gonggaowenjian!=null) {
		this.ruleForm.gonggaowenjian = this.ruleForm.gonggaowenjian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    gonggaowenjianUploadChange(fileUrls) {
	this.ruleForm.gonggaowenjian = fileUrls;
	this.addEditUploadStyleChange()
    },
