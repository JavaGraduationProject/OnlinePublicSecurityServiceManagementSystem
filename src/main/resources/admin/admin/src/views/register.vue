      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.nicheng" class="input" type="text" placeholder="昵称">
			   </div>
			 </div> -->
			<el-form-item label="昵称" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.nicheng" autocomplete="off" placeholder="昵称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			...
			<!-- <div v-if="tableName=='jingwurenyuan'" class="input-group">
			   <div class="label">警号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jinghao" class="input" type="text" placeholder="警号">
			   </div>
			 </div> -->
			<el-form-item label="警号" class="input" v-if="tableName=='jingwurenyuan'">
			  <el-input v-model="ruleForm.jinghao" autocomplete="off" placeholder="警号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jingwurenyuan'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jingwurenyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='jingwurenyuan'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='jingwurenyuan'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='jingwurenyuan'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jingwurenyuan'" class="input-group">
			   <div class="label">邮箱</div>
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='jingwurenyuan'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jingwurenyuan'" class="input-group">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='jingwurenyuan'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.jinghao) && `jingwurenyuan` == this.tableName){
        this.$message.error(`警号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `jingwurenyuan` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `jingwurenyuan` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if(`jingwurenyuan` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
      if(`jingwurenyuan` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮件格式`);
        return
      }
      if(`jingwurenyuan` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
